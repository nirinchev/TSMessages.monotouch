...
#define TSMessageViewMinimumPadding 10.0
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    if (self.iconImageView)
    {
        ...
        {
            // z-align
            self.iconImageView.frame = CGRectMake(self.iconImageView.frame.origin.x, self.titleLabel.frame.origin.y, self.iconImageView.frame.size.width, self.iconImageView.frame.size.height);
        }
    }
    ...
    if (self.button)
    {
        self.button.frame = CGRectMake(self.frame.size.width - self.textSpaceRight,
                                       round(self.frame.size.height / 2.0 - self.button.frame.size.height / 2.0 + verticalOffset / 2.0),
                                       self.button.frame.size.width,
